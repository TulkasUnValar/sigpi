    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "review_type",
                    models.CharField(
                        choices=[("observation", "Observation"), ("rejection", "Rejection")],
                        max_length=20,
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(
                    ("cumulative_percentage__gte", 0), ("cumulative_percentage__lte", 100)
                ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["progress_report", "-created_at"], name="idx_progress_sl_report_time"
            ),
        ),
        migrations.AddIndex(
            model_name="progressstatelog",
