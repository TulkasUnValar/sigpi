...
class MembershipSerializer(serializers.Serializer):
    ...
    def to_representation(self, instance: InstitutionMembership) -> dict:
        return {
            ...
            "centers": [{"id": str(c.id), "name": c.name} for c in instance.centers.all()],
...
class UserSerializer(serializers.Serializer):
    ...
    def to_representation(self, instance) -> dict:
        ...
        memberships = (
            instance.memberships.select_related("institution", "role")
        ...
        return {
            ...
            "is_active": instance.is_active,
            "active_institution_id": (request.session.get("institution_id") if request else None),
